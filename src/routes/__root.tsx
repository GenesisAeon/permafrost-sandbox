...
const APP_NAME = "Permafrost-Sandbox";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Honesty map for permafrost-utac (P60): ESA CCI measured MAGT + Schuur 2022 carbon. Not a bistable tipping element (IPCC AR6). No UTAC/CREP/AFET bridge.",
      },
